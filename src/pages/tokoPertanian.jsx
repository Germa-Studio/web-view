  ...
  return (
    ...
    {[...Array(3)]?.map((_, i)=>(
      <MainCard row transparent center gap="0" key={i}>
        <MainCard width="80%" radius="0" gap="0" style={{border:"solid 1px black"}}>
            <MainCard transparent row>
                <MainCard transparent noPadding>
                    ...
                    <MainCard row transparent noPadding center>
                        ...
                        <p className='font-medium md:pt-10 px-0 md:px-20'>Karanganyar</p>
                        <Image width={200} height={120} src={null} alt="With default placeholder" withPlaceholder />
                        <a href="wa.me/081223445667" className='font-medium md:pt-10 px-0 md:text-3xl'><FontAwesomeIcon icon={faContactBook} width={500} className="text-green-600 ml-2"/></a>
                    </MainCard>
                </MainCard>
            </MainCard>
        </MainCard>
